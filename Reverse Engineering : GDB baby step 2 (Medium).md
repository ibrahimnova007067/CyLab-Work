...
Yet another useful tool known as GDB was added to my collection with the GDB baby step series, and of all the GDB challenges, GDB baby step 2 felt the most special me, because, similar to the Irish-Name-Repo series, it brought to life and actual practice something I studied in AS Computer Science Chapter 5 : Breakpoints.
